...
export const id: Dictionary = {
  ...
  parentSignIn: {
    ...
    subtitle: 'Masuk untuk jadi banknya.',
    email: 'Email',
    password: 'Kata sandi',
    submit: 'Masuk',
  ...
  parentSignUp: {
    title: 'Yuk siapkan keluargamu',
    subtitle: 'Beberapa detail, lalu kamu bisa menambahkan anak.',
    fullName: 'Namamu',
    email: 'Email',
    password: 'Kata sandi',
    phone: 'Nomor telepon',
    ...
    province: 'Provinsi',
    city: 'Kota/kabupaten',
    freeTextHint: 'Ketik sendiri — dropdown hanya tersedia untuk Indonesia.',
    submit: 'Buat akun saya',
    haveAccount: 'Sudah punya akun?',
    signInLink: 'Masuk',
    nameRequired: 'Nama perlu diisi',
    emailInvalid: 'Emailnya sepertinya belum benar',
    passwordTooShort: 'Minimal 8 karakter',
    failed: 'Belum berhasil. Periksa detailnya, lalu coba lagi.',
    emailTaken: 'Sudah ada akun dengan email itu — masuk saja.',
  },

  parentResetPassword: {
    title: 'Atur ulang kata sandi',
    subtitle: 'Kami akan kirim tautan untuk membuat yang baru.',
    email: 'Email',
    submit: 'Kirim tautan reset',
    sent: 'Periksa {email} untuk tautan membuat kata sandi baru.',
    ...
    newPasswordSubmit: 'Simpan kata sandi baru',
    newPasswordTooShort: 'Minimal 8 karakter',
    newPasswordSaved: 'Tersimpan. Masuk dengan kata sandi barumu.',
  },
